package com.thomasyoung.weatherapp
...
class MainActivity : AppCompatActivity() {
    ...
    val CITY: String = "Orlando,US"
    val API: String = "bdd48384c658a23b0cf3aad8a48d01ad"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String>()
    {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val temp = main.getString("temp").substringBefore(".") + "°F"
